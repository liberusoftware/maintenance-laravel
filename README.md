...
> Maintenance planning and operations platform for managing assets, work orders, schedules, and service history.
...
[![Install](https://github.com/liberusoftware/maintenance-laravel/actions/workflows/install.yml/badge.svg?branch=main)](https://github.com/liberusoftware/maintenance-laravel/actions/workflows/install.yml) [![Tests](https://github.com/liberusoftware/maintenance-laravel/actions/workflows/tests.yml/badge.svg?branch=main)](https://github.com/liberusoftware/maintenance-laravel/actions/workflows/tests.yml) [![Docker](https://github.com/liberusoftware/maintenance-laravel/actions/workflows/docker.yml/badge.svg?branch=main)](https://github.com/liberusoftware/maintenance-laravel/actions/workflows/docker.yml) [![Codecov](https://codecov.io/gh/liberusoftware/maintenance-laravel/branch/main/graph/badge.svg)](https://codecov.io/gh/liberusoftware/maintenance-laravel) [![Latest release](https://img.shields.io/github/v/release/liberusoftware/maintenance-laravel?sort=semver)](https://github.com/liberusoftware/maintenance-laravel/releases/latest) [![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](LICENSE.md)

Liberu Maintenance is the deployable maintenance-management application in the Liberu ecosystem. It brings together asset registers, preventive maintenance planning, work orders, service history, and operational workflows on a modular Laravel platform. Independently released capability, presentation, and theme packages are composed here alongside application bootstrapping, environment configuration, panel composition, and cross-package tests.
...
- Maintenance planning, assets, work orders, schedules, service history, and operational reporting
...
```bash
git clone https://github.com/liberusoftware/maintenance-laravel.git
cd maintenance-laravel
composer install
cp .env.example .env
...
also handles this complete meta repository as `maintenance-laravel`.
...
| Boilerplate | [liberusoftware/boilerplate-laravel](https://github.com/liberusoftware/boilerplate-laravel) | Generic modular Laravel foundation used by Liberu applications |
...
Thank you to everyone who helps improve Liberu Maintenance. [View the contributors graph](https://github.com/liberusoftware/maintenance-laravel/graphs/contributors).
