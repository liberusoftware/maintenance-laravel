...
final class MaintenanceReminderNotification extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    {
        return ['maintenance_plan_id' => $this->plan->getKey(), 'title' => "Reminder: {$this->plan->name}", 'days_until_due' => $this->daysUntilDue, 'due_at' => $this->plan->next_due_at];
    }
}
