...
final class MaintenanceDocumentController extends Controller
{
    ...
    private function document(Request $request, string $key): MaintenanceDocument
    {
        return MaintenanceDocument::query()->where('team_id', $this->teamId($request))->findOrFail($key);
    }
