...
class LaborRate extends Model
{
    ...
    public function isActive(?\DateTimeInterface $on = null): bool { $date = $on === null ? now() : $on; return $this->effective_from <= $date && ($this->effective_until === null || $this->effective_until >= $date); }
}
